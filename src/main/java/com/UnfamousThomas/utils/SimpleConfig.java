...
import com.UnfamousThomas.utils.messages;
    ...
    public class SimpleConfig extends YamlConfiguration {
        ...
        public Object get(String path, Object def) {
            if (defaults != null) {
                ...
                if (super.get(path, null) == null) {
                    ...
                    messages.log("&fUpdating &a" + file.getName() + "&f. Set '&b" + path + "&f' to '" + defaultValue + "'");
        ...
        private File extract(String path) {
            final JavaPlugin i = Start.getInstance();
        ...
        private File createFileAndDirectory(String path) {
            ...
            final File datafolder = Start.getInstance().getDataFolder();
